...
const services = [
  {
    ...
    description:
      " Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum corporis possimus, atque minima provident vero laborum obcaecati nam numquam odit?",
    link: "Learn more",
  },
  {
      ...
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            ...
            <h3 className="h3 max-w-[455px] mb-16 col-black">
              {" "}
              I'm a freelance Front-end Developer with over 1 years of
              expirience
            </h3>
            <Link to={"/HiraganaRandomizer"}>
